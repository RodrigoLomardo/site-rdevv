...
const Header = () => {
    return (
        <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
            ...
            <h3 className='flex items-end gap-2 text-xl md:text-2xl mb-3 '>Hi! I'm Rodrigo Lomardo <Image alt='' src={assets.hand_icon} className='w-6' /></h3>

            <h1 className='text-3xl sm:text-6xl lg:text-[66px] '>
                frontend web developer based in London
            </h1>
            <p className='max-w-2xl mx-auto'>
                i am a frontend developer from california, usa with 10 years of experiencia multiple companies liek microsoft, tesla and apple
            </p>
